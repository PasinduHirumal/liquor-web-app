...
class CompanyService {
    constructor () {
        this.collection = db.collection('company_details');
    }
    ...
    async findById(id) {
        try {
            ...
            return new CompanyDetails(userDoc.id, userData);
        } catch (error) {
            throw error;
        }
    }
    ...
    async findAll() {
        try {
            ...
            return usersRef.docs.map(doc => new CompanyDetails(doc.id, doc.data()));
        } catch (error) {
            throw error;
        }
    }
    ...
    async create(data) {
        try {
            ...
            return new CompanyDetails(userRef.id, data);
        } catch (error) {
            throw error;
        }
    }
