...
const ProductFlavourFields = ({ values, errors, touched, handleChange, handleBlur, setFieldValue, loading }) => {
    // Helper function to handle comma-separated array fields
    ...
    // Helper function to get touched/error state for nested fields
                    ...
                    <Form.Group className="mb-3">
                        ...
                        <Form.Control
                            ...
                            value={Array.isArray(values.flavour.herbal_flavours)
                                ...
                                : values.flavour.herbal_flavours || ""}
